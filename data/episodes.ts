...
export const episodes: Episode[] = [
  {
    ...
    duration: "51 min",
    tags: ["AI & Agents", "Developer Experience", "Cloud Infrastructure"],
    timestamps: [
      ...
      { time: "08:35", title: "From Coder to Creator: The Rise of Intent Engineering" },
      { time: "10:21", title: "Why AI Agents Need Predictable APIs, CLIs and Infrastructure" },
      { time: "11:07", title: "Will AI Replace Junior Engineers or Product Managers?" },
      { time: "13:52", title: "Why Communication Skills Matter in AI-Native Software Development" },
      { time: "15:09", title: "Why Institutional Knowledge Still Matters in the AI Era" },
      { time: "18:26", title: "Hiring in the AI Era: PMs, Engineers and AI-Native Teams" },
      { time: "19:41", title: "AI as the Next Programming Language" },
      ...
      { time: "31:03", title: "The Cost of Running AI Agents 24/7" },
      { time: "33:17", title: "Managed Services, Ephemeral Compute and AI Build Workflows" },
      { time: "34:45", title: "Moving AI Builds From the Laptop to the Cloud" },
      { time: "36:37", title: "Why Testing Is the Hardest Part of AI-Generated Code" },
      { time: "38:01", title: "Test-Driven Development, AI Agents and Brownfield Codebases" },
      { time: "40:10", title: "AI Can Ship Bugs at Scale: Why Quality Agents Matter" },
      { time: "41:18", title: "How LLMs Add Chaos Engineering to Software Testing" },
      { time: "42:33", title: "Token Economics: The Hidden Cost of AI Software Development" },
      { time: "44:18", title: "Self-Hosted LLMs vs Managed AI Models" },
      { time: "45:35", title: "Context Windows, Local Models and Cost-Aware AI Development" },
      { time: "47:13", title: "Why Long AI-Generated Spec Docs Fail" },
      { time: "47:55", title: "Right-Sizing Specs for AI Coding Agents" },
      { time: "49:39", title: "Why Smaller Models Can Make Better AI Workflows" },
      { time: "50:24", title: "Horizontal vs Vertical Scaling for AI-Native Engineering Teams" },
      { time: "50:42", title: "Closing Thoughts: The Future of Agentic SaaS and Software Engineering" },
    ],
    guests: [
      {
        name: "John Lorance",
  ...
  },
  {
    ...
    duration: "13 min",
    tags: ["AI Architecture", "Cloud Infrastructure", "Founder Stories"],
    timestamps: [
      { time: "00:00", title: "Introduction: Welcome & Speaker Background" },
      { time: "00:40", title: "The Wake-Up Call: When Fortune 500 Knocks" },
      { time: "01:17", title: "Enterprise Reality Check: InfoSec Rules Everything" },
      { time: "01:38", title: "Why Now? The Exponential Curve of AI Intelligence" },
      { time: "02:51", title: "Raw Intelligence vs Applied Intelligence: The Memory Problem" },
      { time: "04:11", title: "Introducing Zep: The Context Lake for AI Agents" },
      { time: "05:21", title: "The Architecture Fork: Death by Terraform vs BYOC" },
      { time: "06:33", title: "Meeting 'The Bar' for Fortune 500 Deployment" },
      { time: "07:24", title: "Three Walls: No Egress, SCPs, Image Supply Chain" },
      { time: "08:23", title: "How We Actually Shipped: Primitives, Vendors, Sponsors" },
      { time: "11:04", title: "Final Architecture Walkthrough: Inside the Customer VPC" },
      { time: "12:39", title: "Three Key Takeaways for Enterprise AI Deployment" },
    ],
    guests: [
      {
        name: "Daniel Chalef",
        linkedIn: "https://www.linkedin.com/in/danielchalef/",
        bio: "Founder & CEO of Zep AI, building the Context Lake memory layer for AI agents."
      }
    ],
  },
  {
    id: 30,
    title: "Building the Business Behind Open Source AI @ AWS San Francisco [Live]",
    description: "A live panel recorded at AWS San Francisco bringing together open-source AI founders and builders from Zep AI, DataRobot, Command Prompt, Scalar Labs, StreamNative, and Omnistrate. The group moves past technical specs to share strategic and personal reflections on how open source AI teams deploy, scale, and monetize.",
    date: "2026-05-15",
    videoUrl: "https://www.youtube.com/watch?v=wVRZe8xhymQ",
    duration: "142 min",
    tags: ["Open Source", "AI & Agents", "Founder Stories"],
    guests: [
      {
        name: "Daniel Chalef",
        linkedIn: "https://www.linkedin.com/in/danielchalef/",
      ...
      {
        name: "Romi Datta",
        linkedIn: "https://www.linkedin.com/in/ramyanshu-romi-datta-ph-d-b23a2212/",
        bio: "VP and Head of Product Management at DataRobot."
      },
      {
        name: "Joshua Drake",
        linkedIn: "https://www.linkedin.com/in/postgres/",
        bio: "President and CTO of Command Prompt Inc. and a longtime PostgreSQL community leader."
      },
      {
        name: "Joe McCunney",
        linkedIn: "https://www.linkedin.com/in/joe-mccunney/",
        bio: "CEO at Scalar Labs."
      },
      {
        name: "Matteo Merli",
        linkedIn: "https://www.linkedin.com/in/matteomerli/",
        bio: "CTO at StreamNative and co-creator of Apache Pulsar."
      }
    ],
  },
  {
    ...
    duration: "55 min",
    tags: ["Cloud Infrastructure", "SaaS Strategy", "AI & Agents"],
    timestamps: [
      { time: "00:00", title: "Intro: Why Enterprise Customers Demand BYOC" },
      { time: "00:23", title: "Meet the Hosts: AWS Solutions Architects & Omnistrate Founder" },
      { time: "02:44", title: "The Million-Dollar Scenario" },
      { time: "03:18", title: "From Self-Hosted to SaaS to BYOC" },
      { time: "04:43", title: "What is BYOC? Best of Both Worlds Explained" },
      { time: "06:59", title: "Power vs. Trust: Why Big Vendors Can Push Back" },
      { time: "07:36", title: "Valid Use Cases: Latency-Sensitive, Dev Tools & IP-Sensitive Workloads" },
      { time: "09:36", title: "Operational Challenges of Deploying Into Customer Accounts" },
      { time: "10:23", title: "Security Building Blocks: Least Privilege, Private Link & Encryption" },
      { time: "14:30", title: "How AI is Accelerating the BYOC Conversation" },
      { time: "15:00", title: "Meeting Customers Halfway: AWS SaaS Anywhere" },
      { time: "16:30", title: "Agentic AI & Data Gravity" },
      { time: "18:20", title: "Prompt Injection & Multi-Tenant Risks with LLMs" },
      { time: "22:04", title: "Protecting Your IP" },
      { time: "23:27", title: "The Death of the Frontend?" },
      { time: "25:01", title: "Process Knowledge as the New Competitive Advantage" },
      { time: "27:13", title: "The Fear of the Unknown" },
      { time: "28:13", title: "Three-Tier BYOC: Control, Application & Management Planes" },
      { time: "30:40", title: "AWS SaaS Anywhere: Three Deployment Models" },
      { time: "33:20", title: "When to Split the Control Plane" },
      { time: "35:42", title: "Is It Still SaaS? MSP vs. SaaS Debate" },
      { time: "38:25", title: "The Airport Analogy" },
      { time: "39:25", title: "Business Model Impact: Value-Based Pricing vs. Cost Transparency" },
      { time: "40:44", title: "Why ISVs Want Infrastructure Revenue" },
      { time: "42:28", title: "Economies of Scale & Incentive Alignment" },
      { time: "44:27", title: "AI Cost Estimation: The New Pricing Nightmare" },
      { time: "46:20", title: "BYOC for Enterprise Tiers, SaaS for Startup Tiers" },
      { time: "47:19", title: "Land & Expand: Why BYOC Shouldn't Be Your Starting Model" },
      { time: "49:10", title: "Lightning Round: Common BYOC Failure Modes" },
      { time: "50:11", title: "Operational Hell: Configuration Drift" },
      { time: "50:48", title: "Technology Stack Limits" },
      { time: "51:52", title: "Reverse Engineering Risk" },
      { time: "53:48", title: "Deep Domain Knowledge as Your Real Moat" },
      { time: "54:18", title: "Final Thoughts: BYOC as a Business Decision" },
    ],
  },
  {
    id: 28,
    ...
    timestamps: [
      ...
      { time: "09:27", title: "The 'Amazon Abuse' Myth" },
      { time: "10:32", title: "Why Developers Trust Open Source Products More" },
      { time: "11:33", title: "Open Core as the Natural Evolution of Open Source" },
      { time: "12:22", title: "How Couchbase Transitioned: Memcached to Database to Commercial" },
      { time: "13:48", title: "Drawing the Paywall Line Without Alienating the Community" },
      { time: "15:21", title: "Three Commercialization Strategies" },
      { time: "17:38", title: "'Open Source Is Not a Business Model'" },
      { time: "20:13", title: "The MongoDB Problem" },
      { time: "22:17", title: "The Foundation Model: Linux, Postgres & Kubernetes" },
      { time: "24:25", title: "How to Prepare Your Community for Monetization" },
      { time: "27:42", title: "Partnering with AWS: Cloud Strategy for OSS Founders" },
      { time: "30:17", title: "Crawl-Walk-Run: From Open Source to Managed Service" },
      { time: "32:53", title: "Agentic AI Meets Open Source" },
      { time: "35:37", title: "How AI Is Reimagining SaaS Itself" },
      { time: "37:03", title: "Closing Thoughts" },
    ],
    guests: [
      {
        name: "Peter Zaitsev",
        linkedIn: "https://www.linkedin.com/in/peterzaitsev/",
        bio: "Co-founder of Percona, a pioneer in open source database technology."
      },
      {
        name: "Peter Farkas",
        linkedIn: "https://www.linkedin.com/in/peterfarkaspercona/",
        bio: "CEO at Percona and founder of FerretDB, building open source database alternatives."
      },
      {
        name: "Talina Shrotiya",
        linkedIn: "https://www.linkedin.com/in/talinashro/",
        bio: "Engineering Manager at Couchbase, working on the company's managed database platform."
      }
    ],
  },
  {
    ...
    duration: "54 min",
    tags: ["AI & Agents", "Growth & Pricing", "SaaS Strategy"],
    timestamps: [
      { time: "00:00", title: "Welcome: Meet Sebastian Gebski, Michael Cooper & Kamal" },
      { time: "03:47", title: "What Is LLM Tokenomics?" },
      { time: "05:09", title: "Tokens vs. Man-Hours: Are LLM Tokens Replacing Developer Time?" },
      { time: "06:10", title: "Theory of Constraints in Software Engineering" },
      { time: "07:12", title: "From 'LLMs Writing Code Is Not OK' to Doing It Intelligently" },
      { time: "08:31", title: "Token Leaderboards & Claude Opus vs. Haiku" },
      { time: "10:27", title: "Why Developers Resist Agentic Workflows" },
      { time: "12:15", title: "LLM FinOps: AI Token Cost Management" },
      { time: "17:00", title: "Why AI Productivity Gains Are Wildly Inconsistent" },
      { time: "22:19", title: "How Multitasking Engineers Use AI to Go 5-10x Faster" },
      { time: "28:34", title: "Structured Thinking Is the New Coding Skill" },
      { time: "33:08", title: "Is English the New Programming Language?" },
      { time: "34:36", title: "Will AI Replace Software Engineers? The 'Agent Shepherd'" },
      { time: "35:45", title: "'What and Why Beat How'" },
      { time: "37:05", title: "What Is Good Code in the Age of AI?" },
      { time: "38:32", title: "Shadow IT 2.0: Building Your Own App With AI" },
      { time: "41:09", title: "Fast Fashion SaaS & 'Box Organising'" },
      { time: "42:16", title: "Why AI Is Forcing Engineers to Write Better Documentation" },
      { time: "43:15", title: "The Catch-22 of Building AI With AI" },
      { time: "48:46", title: "Would You Invest in a SaaS Startup Today? Is SaaS Dead?" },
      { time: "51:19", title: "What Is SaaS, Really?" },
      { time: "53:01", title: "The Duolingo Test: Which SaaS Products Will Survive AI?" },
      { time: "53:31", title: "Closing & Where to Find Sebastian's Blog" },
    ],
    guests: [
      {
        name: "Sebastian Gebski",
        linkedIn: "https://www.linkedin.com/in/sebastian-gebski-2687bb/",
        bio: "Director of Engineering at AutoPay and author of the 'No Kill Switch' blog, writing on engineering leadership and AI's impact on developer productivity."
      }
    ],
  },
  {
    ...
    duration: "29 min",
    tags: ["Data & Databases", "AI & Agents", "Cloud Infrastructure"],
    timestamps: [
      { time: "00:00", title: "Introduction & Guest Introductions" },
      { time: "01:05", title: "Subbu's Role: Open Source Databases at AWS" },
      { time: "01:22", title: "3 Disruptive AI Access Patterns Overview" },
      { time: "02:00", title: "Pattern 1: Vector Similarity Search at Scale" },
      { time: "03:15", title: "Pattern 2: Hybrid Retrieval (Vector + SQL)" },
      { time: "04:49", title: "Pattern 3: Unpredictable Agent-Generated Query Patterns" },
      { time: "06:30", title: "What Agentic AI Means for Database as a Service" },
      { time: "07:49", title: "When to Use Postgres vs. Vector Databases" },
      { time: "09:19", title: "Is Postgres the 'Operating System' for Modern Apps?" },
      { time: "11:10", title: "Why Startups Still Default to Postgres" },
      { time: "13:42", title: "Evolution of the DBaaS Market & Cloud Migration Trends" },
      { time: "16:35", title: "Billion-Scale Semantic Search & Legal Tech Example" },
      { time: "17:45", title: "Self-Manage or Use Managed DB Services?" },
      { time: "20:49", title: "Native AWS vs. Managed Services vs. DIY" },
      { time: "22:08", title: "Shifting Deployment Models: BYOC & Regulatory Pressures" },
      { time: "24:22", title: "How RDS/Aurora Addresses New Pricing & Agent Workloads" },
      { time: "26:51", title: "Database Savings Plan & Avoiding Engine Lock-in" },
      { time: "28:02", title: "Aurora Fast Cloning + Data Masking for AI Agents" },
      { time: "29:16", title: "Closing Remarks" },
    ],
    guests: [
      {
        name: "Subbu Ramarao",
        linkedIn: "https://www.linkedin.com/in/subbumr/",
        bio: "Head of Worldwide GTM Specialists for Relational Databases at AWS, focused on Postgres, RDS, and Aurora for AI-era workloads."
      }
    ],
  },
  {
    ...
    duration: "52 min",
    tags: ["Data & Databases", "AI & Agents", "Open Source"],
    timestamps: [
      { time: "00:00", title: "Intro: The intersection of Cloud-Native Data and AI Agents" },
      { time: "01:04", title: "Meet Sergey Pronin: From Percona to Founding Solanica" },
      { time: "02:20", title: "The 'Lego Mindset': Building interchangeable infrastructure blocks" },
      { time: "06:09", title: "Data as Fuel: Why 80% of valuable data is 'Dark Matter'" },
      { time: "08:52", title: "The Risk of Model Collapse" },
      { time: "11:35", title: "The Resurgence of Postgres" },
      { time: "13:06", title: "Building on Open Everest and the Sovereign AI niche" },
      { time: "15:21", title: "Databases as Containers: Portability without vendor lock-in" },
      { time: "16:59", title: "Persistence on Kubernetes: Treating databases like cattle" },
      { time: "18:26", title: "Decoupling storage and compute" },
      { time: "21:15", title: "When Agents Control the Data: API-driven provisioning" },
      { time: "26:37", title: "Internal Development Platforms (IDPs) and private RAG" },
      { time: "33:48", title: "Short-term vs. Long-term Memory for agents" },
      { time: "35:08", title: "The 'Internet of Agents'" },
      { time: "38:12", title: "The Reliability Threshold: Trusting an agent" },
      { time: "42:53", title: "Open Source Strategy: Donating Open Everest to the CNCF" },
      { time: "46:28", title: "Building Community: The 'Two Bucket' approach" },
      { time: "50:56", title: "Closing Thoughts" },
    ],
    guests: [
      {
        name: "Sergey Pronin",
